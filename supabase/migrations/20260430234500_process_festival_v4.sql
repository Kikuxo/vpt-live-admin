-- ============================================================================
-- VIP System v2 — process_festival v4 (fix unlock_achievement signatures)
-- Fecha: 2026-04-30 23:45
--
-- Bug: la versión v3 llamaba unlock_achievement con argumentos en orden
--      incorrecto: (user_id, code, metadata, grant_points)
--
-- Signatura real:
--   unlock_achievement(p_user_id uuid, p_achievement_code text,
--                      p_grant_points boolean DEFAULT true,
--                      p_festival_id uuid DEFAULT NULL,
--                      p_metadata jsonb DEFAULT '{}')
--
-- Esta migración solo reescribe la función. No toca tablas ni columnas.
-- ============================================================================
...
do $$
begin
  raise notice 'process_festival v4 (unlock_achievement signatures fixed) creada';
end $$;
